...
\begin{itemize}
  ...
  \item \textbf{Framework \& Alat:} PyTorch, Scikit-learn, Hugging Face, OpenCV, Transformers, W\&B
  \item \textbf{Pemrograman:} Python, SQL, Git, Linux
  \item \textbf{Lainnya:} Microsoft Power BI, Figma
\end{itemize}
...
\begin{itemize}
  \item \textbf{Bahasa:} Indonesia, Inggris (Menengah)

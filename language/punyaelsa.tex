Informatics Engineering graduate with experience in AI evaluation, LLM-assisted data annotation, prompt-based analysis, RAG systems, and multimodal model assessment. Skilled in evaluating model outputs against source evidence, identifying hallucinations and unsupported claims, writing structured evaluation rationales, and maintaining high attention to data quality. Strong background in NLP, LLM integration, dataset curation, and model evaluation, with native Indonesian proficiency and professional English working proficiency.
...
\begin{itemize}
  ...
  \item Reviewed and validated annotation quality to reduce labeling ambiguity and improve consistency between self-harm and non-self-harm categories
...
\begin{itemize}
  ...
  \item \textbf{AI Evaluation \& Annotation:} AI Response Evaluation, Hallucination Detection, Error Analysis, LLM-assisted Annotation, Data Quality Review
